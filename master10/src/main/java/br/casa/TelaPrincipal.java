...
public class TelaPrincipal extends Tela{
	...
	private void configMenu() {
		super.mntmImprimirOrcamento.addActionListener(new ActionListener() {
			@Override
	...
	protected void adicionar() {
		...
		p.setCodigo(Long.parseLong(super.txfCodigo.getText()));
		p.setDescricao(super.txfDesc.getText().trim());
		p.setValorDolar(new BigDecimal(super.txfPrecoD.getText().trim()));
		p.setValorDolar(new BigDecimal(super.txfPrecoR.getText().trim()));
		p.setDolar(new BigDecimal(super.txfDolar.getText().trim()));
	...
	protected void carregarLinha(int idx) {
		...
		super.txfCodigo.setText(String.valueOf(p.getCodigo()));
